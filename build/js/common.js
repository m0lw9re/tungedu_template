...
if (strAuthen == "") {
  var googleId =
    "16523143533-ovv9lj8c7i8sv36sv3lguom0msmdk8ah.apps.googleusercontent.com";
}
...
function getReferRegister() {
  var n = window.location.href,
    ...
    i = isNaN(t) ? "" : t;
  return {
    EventKey: getCookie("event" + i),
    Refer: getCookie("refer" + i),
  };
}
        ...
        i
          ? ((n += '<div class="down-time">'),
            e > 0 &&
              ...
              (n += "<span>" + e + "</span>"),
              (n +=
                "<span>" + translate.instant("CONTEST_LABEL_DAYS") + "</span>"),
              (n += "</div>"),
              (n += '<label class="dot">:</label>')),
            (n += '<div class="inline-block">'),
            (n += "<span>" + o + "</span>"),
            (n +=
              "<span>" + translate.instant("CONTEST_LABEL_HOURS") + "</span>"),
            (n += "</div>"),
            (n += '<label class="dot">:</label>'),
            (n += '<div class="inline-block">'),
            (n += "<span>" + s + "</span>"),
            (n +=
              "<span>" +
              translate.instant("CONTEST_LABEL_MINUTES") +
              "</span>"),
            (n += "</div>"),
            (n += '<label class="dot">:</label>'),
            (n += '<div class="inline-block">'),
            ...
            (n +=
              "<span>" +
              translate.instant("CONTEST_LABEL_SECONDS") +
              "</span>"),
            (n += "</div>"),
            (n += "</div>"))
          : ((n += "<span class='time_span'>"),
            e > 0 &&
              (n +=
                ...
                e +
                "</span>" +
                translate.instant("SYSTEM_TIME_DAY_CHAR") +
                " "),
...
function getKey(n) {
  try {
    ...
    eventChooser == 116 &&
      n.ctrlKey &&
      localStorage.removeItem(PKLService.ArrConfig.strLangStorage);
    n.ctrlKey &&
      eventChooser == 82 &&
      localStorage.removeItem(PKLService.ArrConfig.strLangStorage);
  } catch (t) {
...
function checkVerScrollBarDisplay(n) {
  ...
  if (((n = n || 0), (t = $("#layout-footer")), t.length)) {
    if (
      ...
      (i = $(window).height() < document.body.scrollHeight),
      r || !i)
    ) {
      var u = t.parent(),
  ...
  n.getStyledContent = function (n) {
    ...
    return (
      $(t)
        ...
        .each(function () {
          this.tagName === "IMG" &&
            ((this.style.maxWidth = "100%"), this.removeAttribute("height"));
...
function setCurrentmenu() {
  ...
  $(".menu-main-menu li").each(function () {
    ...
    i == $(this).find("a").attr("href").toLowerCase() &&
      $(this).addClass("current");
  });
  n = window.location.href.toLocaleLowerCase();
  n.toLocaleLowerCase().indexOf("aboutus") > -1 &&
    ($("#img-about").addClass("hide"),
    $("#img-about-select").removeClass("hide"));
  n.toLocaleLowerCase().indexOf("help") > -1 &&
    ($("#img-help").addClass("hide"),
    $("#img-help-select").removeClass("hide"));
}
...
function changeToSlug(n) {
  if (n != "") {
    ...
    return (
      ...
      (t = t.replace(/á|à|ả|ạ|ã|ă|ắ|ằ|ẳ|ẵ|ặ|â|ấ|ầ|ẩ|ẫ|ậ/gi, "a")),
      (t = t.replace(/é|è|ẻ|ẽ|ẹ|ê|ế|ề|ể|ễ|ệ/gi, "e")),
      (t = t.replace(/i|í|ì|ỉ|ĩ|ị/gi, "i")),
      (t = t.replace(/ó|ò|ỏ|õ|ọ|ô|ố|ồ|ổ|ỗ|ộ|ơ|ớ|ờ|ở|ỡ|ợ/gi, "o")),
      (t = t.replace(/ú|ù|ủ|ũ|ụ|ư|ứ|ừ|ử|ữ|ự/gi, "u")),
      (t = t.replace(/ý|ỳ|ỷ|ỹ|ỵ/gi, "y")),
      (t = t.replace(/đ/gi, "d")),
      (t = t.replace(
        /\`|\~|\!|\@|\#|\||\$|\%|\^|\&|\*|\(|\)|\+|\=|\,|\.|\/|\?|\>|\<|\'|\"|\:|\;|_/gi,
        ""
...
function __handleSuccessAlerting(n) {
  ...
  return (
    t &&
      (NOFICATION_GLOBAL
        ? NOFICATION_GLOBAL.update({
            message: translate.instant(n.Message),
          })
        : (NOFICATION_GLOBAL = $.notify(translate.instant(n.Message)))),
    t
  );
}
...
!(function (n) {
  ...
  String.format = function () {
    for (var t = arguments[0], n = 1; n < arguments.length; n++)
      t = t.replace(RegExp("\\{" + (n - 1) + "\\}", "gm"), arguments[n]);
    return t;
  };
  n.extend(i.prototype, {
            ...
            switch (t) {
              case "type":
                ...
                this.$ele
                  ...
                  .removeClass("progress-bar-" + n.settings.type);
                n.settings.type = r[t];
                this.$ele
                  .addClass("alert-" + r[t])
                  .find('[data-notify="progressbar"] > .progress-bar')
              ...
              case "icon":
                ...
                "class" == n.settings.icon_type.toLowerCase()
                  ? u.removeClass(n.settings.content.icon).addClass(r[t])
                  : (u.is("img") || u.find("img"), u.attr("src", r[t]));
                break;
              case "progress":
    ...
    placement: function () {
      ...
      switch (
        (n(
          ...
          return (i = Math.max(
            i,
            parseInt(n(this).css(f.placement.from)) +
              parseInt(n(this).outerHeight()) +
              parseInt(f.spacing)
          ));
        }),
    ...
    close: function () {
      ...
      setTimeout(function () {
        i ||
          (t.$ele.remove(), t.settings.onClosed && t.settings.onClosed(t.$ele));
      }, 600);
    },
  ...
  (function () {
    function n(n) {
      return (
        "background:" +
        n +
        "; color:white; padding: 5px; font-size: 40px; border-radius: 10px; margin: 1px;"
      );
    }
    console.log(
      "%cF%cP%cT%cCODELEARN.IO",
      n("#084aa0"),
      n("#f36f21"),
      n("#49b644"),
      n("#ff6d3a")
...
statusAndNameBatch = function (n) {
  ...
  return n.IsApplyRegisterStart && i < u
    ? ((t.Status = "status_wait"),
      (t.Text = translate.instant(objStatus.ToStartRegister)),
      (t.Time = u - i),
      t)
    : (r > i && r > u && n.IsApplyRegisterStart && u <= i) ||
      (r > i && !n.IsApplyRegisterStart)
    ? ((t.Status = "status_register"),
      (t.Text = translate.instant(objStatus.ToEndRegister)),
      (t.Time = r - i),
      t)
    : r <= i && i < f
    ? ((t.Status = "status_upcoming"),
      (t.Text = translate.instant(objStatus.ToStartContest)),
      (t.Time = f - i),
      t)
    : f <= i && i < e
    ? ((t.Status = "status_running"),
      (t.Text = translate.instant(objStatus.ToEndContest)),
      (t.Time = e - i),
      t)
    : i >= e
    ? ((t.Status = "status_finish"),
      (t.Text = translate.instant(objStatus.Finish)),
      t)
    : t;
};
$.notifyDefaults !== null &&
...
//   changeYear: !0,
//   yearRange:
//     new Date().getFullYear() - 110 + ":" + (new Date().getFullYear() + 50),
// });
var SystemConstant = {
    Method: {
      GET: 1,
  ...
  translate = (function () {
    var n = [],
      ...
      t = function () {
        $.get(
          PKLService.ArrConfig.url +
            "/api/language/GetAllMessages?version=" +
          ...
          function (t) {
            ...
            localStorage.setItem(
              PKLService.ArrConfig.strLangStorage,
              JSON.stringify(i)
            );
            r();
          }
    ...
    return {
      ...
      init: function () {
        ...
        u == null
          ? t()
          : ((i = JSON.parse(u)),
            i.strVersion == PKLService.ArrConfig.strVersion &&
            i.strLangCode == PKLService.ArrConfig.strLangCode
              ? ((n = i.ArrLang), n != null ? r() : t())
              : t());
      },
      instant: function (n) {
  ...
  PKLService = (function () {
        ...
        if (n.statusText == "timeout")
          NOFICATION_GLOBAL
            ? NOFICATION_GLOBAL.update({
                ...
                message: translate.instant("SYSTEM_MESSEGER_REQUEST_TIME_OUT"),
              })
            : (NOFICATION_GLOBAL = $.notify(
                translate.instant("SYSTEM_MESSEGER_REQUEST_TIME_OUT"),
                {
                  type: "codecamp-danger",
                }
              ));
    ...
    return {
      ...
      withTimeBeforeShowingLoadingIndicator: function (n) {
        return (
          (this.ArrConfig.milliSecondsBeforeShowingLoadingIndicator = n), this
        );
      },
      ...
      init: function (n) {
        ...
        PKLService.ArrConfig.strLangCode == "jp"
          ? ($.datetimepicker != undefined && $.datetimepicker.setLocale("ja"),
      ...
      get: function (r) {
        ...
        if (
          ((r = $.extend(h, r)),
          (r.reqeustid = PKLService.newid()),
          (u = ""),
          r.api == null)
        )
          u = PKLService.ArrConfig.strApiURL + r.url;
        else {
          if (r.data == null || r.data == undefined || r.data == "")
            throw new "Service parameters not passed! Please input parameters for data"();
          for (
            u = PKLService.ArrConfig.strApiURL + r.api + "?",
              o = t(r.data),
              f = "",
              e = 0;
            e < o.length;
            ...
            (f = f + o[e].key + "=" + encodeURI(o[e].value)),
              e < o.length - 1 && (f = f + "&");
          u = u + f;
        }
        return (
                  ...
                  r.loading == null
                    ...
                    ? ($(r.loading).prepend(n()),
                      ...
                      $(r.loading)
                        ...
                        .addClass("el-loading-in-content")
                        .attr("control-effect-index", r.reqeustid),
                      $(r.loading)
                        .find(".el-loading-mask")
                        .css({
                          width: $(r.loading).width() + "px",
                          height: $(r.loading).height() + "px",
                          top: "auto",
                          left: "auto",
                          right: "auto",
                          bottom: "auto",
              ...
              if (
                ...
                r.isShowLoading == !0 &&
                  (r.loading == null
                    ...
                    : ($(r.loading).find(".el-loading-mask").remove(),
                      PKLService.loading.removeEffect(r.reqeustid))),
      ...
      post: function (t) {
        ...
        return (
          ...
          (r =
            t.api == null
              ? PKLService.ArrConfig.strApiURL + t.url
              : PKLService.ArrConfig.strApiURL + t.api),
                  ...
                  t.loading == null
                    ...
                    ? ($(t.loading).prepend(n()),
                      ...
                      $(t.loading)
                        .find(".el-loading-mask")
                        .addClass("el-loading-in-content")
                        .attr("control-effect-index", t.reqeustid),
                      $(t.loading)
                        .find(".el-loading-mask")
                        .css({
                          width: $(t.loading).width() + "px",
                          height: $(t.loading).height() + "px",
                          top: "auto",
                          left: "auto",
                          right: "auto",
                          bottom: "auto",
          ...
          (o = function (n) {
            ...
            t.isShowLoading == !0 &&
              (t.loading == null
                ? PKLService.loading.removeRequest()
                : ($(t.loading).find(".el-loading-mask").remove(),
                  PKLService.loading.removeEffect(t.reqeustid)));
            n.Errors != null && n.Errors.length > 0
              ? ((i = ""),
                n.Errors.forEach(function (n) {
          ...
          $.ajax({
              ...
              if (t.reCaptchaSiteKey) {
                ...
                return (
                  grecaptcha.ready(function () {
                    grecaptcha
                      .execute(t.reCaptchaSiteKey, {
                        action: t.reCaptchaAction,
                      })
                      .then(function (n) {
                        typeof r == "string"
                          ? (r += "&RecaptchaResponse=" + n)
                          : (r.RecaptchaResponse = n);
                        i = $.extend({}, i);
                        i.beforeSend = e;
                        i.data = r;
            ...
            error: function (n) {
              ...
              if (
                n.status == 524 &&
                ((u = t.OnTimedOut), u && ((r = u(n)), r.fail && r.done))
              ) {
                r.fail(function (n) {
                  e(n);
                }).done(function (n) {
        ...
        return (
          (ArrEffect = []),
          {
            ...
            findRequest: function (n) {
              for (var i = null, t = 0; t < ArrEffect.length; t++)
                ArrEffect[t].request == n && (i = ArrEffect[t]);
              return i;
            },
            ...
            removeEffect: function (n) {
              for (var t = 0; t < ArrEffect.length; t++)
                ArrEffect[t].request == n && ArrEffect.remove(t);
            },
            addRequest: function () {
              this.ArrLoading.intTotalRequest =
                this.ArrLoading.intTotalRequest + 1;
              $(t.panel).length < 1 &&
                ($("body").append(
                  '<div id="' + t.panel.replaceAll("#", "") + '"></div>'
                ),
                $(t.panel).append(n()),
                $(t.panel)
                  .find(".el-loading-mask")
                  .addClass("el-loading-full-screen"));
              PKLService.loading.ArrLoading.isloading = !0;
            },
            removeRequest: function () {
              PKLService.loading.ArrLoading.intTotalRequest =
                PKLService.loading.ArrLoading.intTotalRequest - 1;
              PKLService.loading.ArrLoading.intTotalRequest < 0 &&
                (PKLService.loading.ArrLoading.intTotalRequest = 0);
              PKLService.loading.ArrLoading.intTotalRequest == 0 &&
                (jQuery(t.panel).remove(),
                (PKLService.loading.ArrLoading.isloading = !1));
            },
          }
        );
      })(),
  ...
  modal = (function () {
    var n = {
      ...
      t = function (n) {
        function u() {
          ...
          strHTML =
            '<div class="TMSModal modal-size-' +
            n.size +
            " " +
            r +
            '"  aria-hidden="true" id="pnModalsPopup_' +
            t +
            '" tabindex="' +
            t +
            '"';
          n.size == 1
            ? (strHTML = strHTML + 'role="basic"')
            : n.size == 2 || n.size == 3
            ? (strHTML = strHTML + 'role="dialog"')
            : n.size > 3 && (strHTML = strHTML + 'data-width="' + n.size + '"');
          strHTML = strHTML + ">";
          strHTML =
            strHTML +
            '<a data-target="#pnModalsPopup_' +
            +t +
            '" id="pnModalsPopupShowButton_' +
            t +
            '" data-toggle="modal" style="display:none">show model</a>';
          strHTML =
            strHTML +
          ...
          strHTML =
            n.showHeader == !0
              ? strHTML +
                ...
                n.css.header +
                '"><button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button><h4 class="modal-title">Modal Title</h4></div>'
              : strHTML +
                '<div class="modal-header header-close-right" style="' +
                n.css.header +
            ...
            (strHTML =
              n.htmlFotder == ""
                ? strHTML +
                  ...
                  translate.instant("SYSTEM_CONFIRM_CONFIRM_CLOSE") +
                  "</button></div>"
                : strHTML + n.htmlFotder),
            (strHTML = strHTML + "</div>"));
      ...
      i = function (n) {
        ...
        t =
          n.OnSuccess == undefined
            ? '<button type="button" style="min-width: 88px;" action="close" class="btn btn-primary btn-sm btn-confirm-cancel">' +
              n.strOKButton +
              "</button>"
    ...
    return {
      ...
      removePopup: function (n) {
        n == undefined
          ? ($(
              "#pnModalsPopup_" + modal.countPopup() + ",.modal-backdrop"
            ).remove(),
            $("body").css("overflow", "auto"))
          : ($("#pnModalsPopup_" + n + ",.modal-backdrop").remove(),
            $("body").css("overflow", "auto"));
      },
      popup: function (n) {
        t(n);
...
$.fn.loadJS = function (n) {
  for (
    var t, f, e, r = document.getElementsByTagName("script"), u = !0, i = 0;
    i < r.length;
    i++
  )
    (t = r[i].getAttribute("src")),
      t != null && t !== undefined && t.indexOf(n) >= 0 && (u = !1);
  f = PKLService.url() + n;
  u == !0 &&
    ((e = $("<script type='text/javascript' src='" + f + "'>")),
    $("head").append(e));
};
$.fn.extend({
  downtime: function (n) {
    var t = function (n, t) {
      for (var u = Math.ceil(t / 1e3), r = -1, i = 0; i < n.length; i++)
        u == n[i] && (r = n[i]);
      return r;
    };
    return this.each(function () {
      var u = {
          seconds: 5e3,
          scope: null,
          expired: translate.instant("PAGES_BATCH_ACTIONS_EXPIRED"),
          timeNow: new Date(),
          label: "",
          timeCallBack: [],
          data: {},
      ...
      r = setInterval(function () {
        ...
        n.customTime
          ? ((u += '<div class="down-time">'),
            ...
            (u += "</div>"))
          : (n.label.length > 0 &&
              (u = "<span class='time_label'>" + n.label + "</span>"),
        ...
        n.scope.html(u);
        n.timeCallBack.length > 0 &&
          ((o = t(n.timeCallBack, f)),
          o > -1 && n.callback.call(this, o, n.scope));
        f < 0 &&
          (clearInterval(r),
          n.scope.html(n.expired),
          n.timeOut.call(this, n.data, n.scope));
        n.callback.call();
      }, 1e3);
    });
  },
    ...
    return this.each(function () {
      ...
      i = setInterval(function () {
        var e = new Date().getTime(),
          ...
          r = "";
        n.label.length > 0 &&
          (r = "<span class='time_label'>" + n.label + "</span>");
        ...
        $(this)
          ...
          .bind("change", function () {
            for (var i = 0; i < n.length; i++)
              (n[i].checked = this.checked), $(n[i]).change();
  ...
  paging: function (n) {
    ...
    var f = function (n, t) {
      ...
      s = function () {
        ...
        if (o.length > 1)
          for (e = o[1].split("&"), u = 0; u < e.length; u++)
            (r = e[u].split("=")),
              r.length > 0 &&
                r[0].toString().toLowerCase() !=
                  n.config.apiCurrPage.toLowerCase() &&
                r[0].toString().toLowerCase() !=
                  n.config.apiPageSize.toLowerCase() &&
                (i = r.length > 1 ? i + r[0] + "=" + r[1] : i + r[0]),
              u < e.length - 1 && f("&", i) == !1 && (i = i + "&");
        f("&", i) == !1 && (i = i + "&");
        i =
          i +
          n.config.apiCurrPage +
          "=" +
          t.intCurrPage +
          "&" +
          n.config.apiPageSize +
          "=" +
          t.intPageSize;
      },
      i = function () {
        ...
        if (n.url.length > 0) {
          for (
            u = PKLService.swithObject(n.data),
              i = n.url,
              i.indexOf("?") < 0 && (i += "?"),
              r = 0;
            r < u.length;
            ...
            (i = i + u[r].key + "=" + encodeURI(u[r].value)),
              r < u.length - 1 && (i = i + "&");
          i =
            i +
            "&" +
          ...
          n.config.urlInit == !0 &&
            ((i =
              t.countRequest == 0
                ? i + "&" + n.config.urlInitPara + "=true"
                : i + "&" + n.config.urlInitPara + "=false"),
            (t.countRequest = t.countRequest + 1));
          f = t.scope;
          o = !0;
          n.fullLoading == null
            ? (o = !1)
          ...
          PKLService.get({
            ...
            OnSuccess: function (i) {
              ...
              n.OnRender.call(
                this,
                i.Data,
                t.scope.find(".data-gridview-paging"),
                {
              ...
              t.intTotalRecode > 0 &&
              (t.intTotalPage > 1 || n.config.changePageSize == !0)
                ? e()
                : t.scope.find(".pagination").html("");
            },
          });
        } else {
          for (
          ...
          n.OnRender.call(this, l, t.scope.find(".data-gridview-paging"), {
            currPage: t.intCurrPage,
            pageSize: t.intPageSize,
            totalRecode: t.intTotalPage,
          });
      ...
      e = function () {
        ...
        for (
          t.intCurrPage == 1 && (o = !1),
            r =
              r +
              '<li class="' +
              $.fn.isVal(o, !0, "page-item", "disabled") +
              '"><a class="page-link"  data="--"><i class="cl-icon-angle-double-left"></i></a></li></a></li>',
            r =
              r +
              '<li class="' +
              $.fn.isVal(o, !0, "page-item", "disabled") +
              '"><a class="page-link"  data="-"><i class="cl-icon-angle-left"></i></a></li>',
          ...
          u != t.intCurrPage &&
            ...
            (r =
              r +
              '<li class="page-item"><a class="page-link number" data="' +
              u +
              '">' +
              u +
              "</a></li>");
        for (
          r =
            r +
            '<li class="active"><a class="page-link number" data="' +
            t.intCurrPage +
            '">' +
            t.intCurrPage +
            "</a></li>",
        ...
        r =
          r +
          '<li class="' +
          $.fn.isVal(e, !0, "page-item", "disabled") +
          '"><a class="page-link" data="+"><i class="cl-icon-angle-right"></i></a></li>';
        r =
          r +
          '<li class="' +
          $.fn.isVal(e, !0, "page-item", "disabled") +
          '"><a class="page-link" data="++"><i class="cl-icon-angle-double-right"></i></a></li>';
        n.showGoPage == !0 &&
          t.intTotalPage >= n.pageMargin * 2 + 1 &&
          ((r =
            r +
            '<li class="page-input"><span style="width:52px;"><input type="number" value="' +
            t.intCurrPage +
            '"></span></li>'),
          (r =
            r +
            '<li class="page-item"><a class="page-link" data="GO">GO</a></li>'));
        ...
        n.label.totalRecode == !0 &&
          (r =
            r +
            "<li class='page-label'><b>[" +
            t.intTotalRecode +
            "]</b></li>");
        ...
        t.scope
          ...
          .click(function () {
            var n = $(this).attr("data"),
              ...
              r;
            n == "GO"
              ? ((u = t.scope.find(".pagination").find("input")[0]),
                (r = $(u).getNumber()),
                r >= 1 && r <= t.intTotalPage
                  ? ((t.intCurrPage = r), i())
                  : $(u).focus())
              : (n == "+"
                  ? ((t.intCurrPage = t.intCurrPage + 1),
                    t.intCurrPage > t.intTotalPage && (t.intCurrPage = 1))
                  : n == "++"
                  ? (t.intCurrPage = t.intTotalPage)
                  : n == "-"
                  ? ((t.intCurrPage = t.intCurrPage - 1),
                    t.intCurrPage < 1 && (t.intCurrPage = t.intTotalPage))
    ...
    return this.each(function () {
      if (
        ((t.scope = $(this)),
        $(this).html(
          '<div class="data-gridview-paging"></div><div class="col-md-12 text-center paging-common"><ul class="pagination" style="' +
            n.strCSS +
            '"></ul></div>'
        ),
        n.urlRender == !0)
  ...
  translate: function () {
    for (
      var r,
        ...
        f,
        e,
        i = $(this).find("translate:not([label-init='true'])"),
        n = 0;
      n < i.length;
      n++
    )
      (r = $(i[n]).text()),
        $(i[n]).html(translate.instant(r)).attr("label-init", "true"),
        $(i[n]).html(translate.instant(r)).attr("translate-code", r);
    for (t = $(this).find("[translate]"), n = 0; n < t.length; n++)
      (u = $(t[n]).attr("translate")),
        $(t[n]).attr("label-init") == undefined &&
          u != undefined &&
          ((f = $(t[n]).attr(u)),
          (e = translate.instant(f)),
          $(t[n]).attr(u, e),
          $(t[n]).attr("label-init", "true").attr("translate-code", f));
  },
  getNumber: function () {
    var n = $(this).val(),
      t;
  ...
  getDateString: function () {
    ...
    return n.getDate() < 10
      ? "0" + n.getDate() + " " + n.getMonthName() + " " + n.getFullYear()
      : n.getDate() + " " + n.getMonthName() + " " + n.getFullYear();
  },
  isNumber: function () {
    var n = $(this).val();
    return (
      (n = n.Replace(",", "")), (n = n.trim()), n.length == 0 ? !1 : !isNaN(n)
    );
  },
  isDate: function () {
    var n = $(this).val(),
  ...
  isEmail: function () {
    ...
    return t.length < 3
      ? !1
      : ((n = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/), n.test(this.toString()));
  },
  autoReSize: function () {
    return this.each(function () {
      $(this).attr("disabled", "").css({
        width: "100%",
      });
      this.scrollHeight > 0
        ? $(this).css({
...
Date.prototype.getDateString = function () {
  return this.getDate() < 10
    ? "0" +
        ...
        " " +
        this.getFullYear()
    : this.getDate() + " " + this.getMonthName() + " " + this.getFullYear();
};
...
String.prototype.getLocalDate = function () {
  var t = {
    ...
    i = moment(this, "YYYY-MM-DD HH:mm:ss [GMT]ZZ").locale(
      LANG_CURRENT == "jp" ? "ja" : LANG_CURRENT
    ),
    n = new Date(i),
    r =
      LANG_CURRENT == "vn" ? "vi-VN" : LANG_CURRENT == "jp" ? "ja-JP" : "en-US";
  return n.getHours() >= 0
    ? n.toLocaleTimeString(r, t)
    : PKLService.ArrConfig.strLangCode == "en"
    ? n.toLocaleDateString("en-US", t)
    : n.toLocaleDateString("ja", t);
};
...
String.prototype.render = function () {
  ...
  return this.replace(/{{.*?}}/g, function (i) {
    try {
      ...
      return (
        /(.*?)/.test(r) &&
          ((r = r.replace(/\((.*?)\)/, '(getValue(otherData, "$1"))')),
          (r = r.trim())),
        t(n, r) || eval(r) || i
      );
    } catch (u) {
      console.error(new Error("Sai cú pháp: " + u.message));
    }
  });
};
...
window.addEventListener("resize", function () {
  for (var r, t, i = $("body .el-loading-in-content"), n = 0; n < i.length; n++)
    (r = $(i[n]).attr("control-effect-index")),
      r != undefined &&
        ((t = PKLService.loading.findRequest(r)),
        t != null &&
          $(i[n]).css({
            width: $(t.scope).width() + "px",
            height: $(t.scope).height() + "px",
          }));
...
select2Language = {
  ...
  inputTooLong: function (n) {
    ...
    return translate.instant(
      "SELECT2_MESSAGE_INPUT_TOO_LONG",
      t,
      t != 1 ? "s" : ""
    );
  },
  ...
  maximumSelected: function (n) {
    return translate.instant(
      "SELECT2_MESSAGE_MAXIMUM_SELECTED",
      n.maximum,
      n.maximum != 1 ? "s" : ""
    );
  },
...
String.prototype.getStringFitInRect = function (n, t, i) {
  ...
  if (
    (n instanceof HTMLElement &&
      ...
      (t = n.getComputedCssText())),
    (f = this.getHeight(n.width, t)),
    f <= n.height)
  )
    return this;
  for (
    var r = this, u = Math.ceil(r.length / 2), o = u, e = 1, s = !1;
    f != n.height || Math.abs(u) != 1;

  ) {
    if (
      ((u = e * Math.ceil(Math.abs(u) / 2)),
      u == 0 && (u = e),
      (o += u),
      (r = this.substring(0, Math.min(o, this.length))),
      s && e == -1)
    )
      break;
  ...
  arguments.length == 1 &&
    (isNaN(n)
      ? n &&
        ...
        !isNaN(n.width) &&
        !isNaN(n.height) &&
        ((u = n), (r = this.getComputedCssText()))
      : ((t = n), (n = this.offsetWidth)));
  i = this.innerHTML;
  i || (i = this.title);
  n &&
    t &&
    ((r = this.getComputedCssText()),
    (f = i.getSingleLineHeight(r)),
    (u = {
      width: n,
      height: f * t,
    }));
...
String.prototype.toGMTFormat = function (n) {
  ...
  return (
    ...
    n === !0
      ? moment
          .utc(t, "YYYY-MM-DD HH:mm:ss [GMT]ZZ")
          .format("YYYY-MM-DD HH:mm:ss [GMT]ZZ")
      : moment(t, "YYYY-MM-DD HH:mm:ss [GMT]ZZ").format(
...
var imgComment = resourcePath + "/Images/code-learn/challenges-comment.svg?v=1",
  ...
  imgTaskPoint =
    resourcePath + "/Images/code-learn/challenges-task-point.svg?v=1",
...
$.Templates = {
  ...
  createTag: function (n) {
    var i, t;
    if (n == "") return "";
    for (i = n.split(","), txt = "", t = 0; t < i.length; t++)
      txt += '<span class="tag tag-default">' + i[t] + "</span>";
    return txt;
  },
  ...
  renderTaskSummary: function (n, t, i, r, u, f) {
    var o = t ? '<img class="img-done" src="' + imgDone + '"/>' : "",
      ...
      h = n.Name,
      c = n.UserLevel.IsAdmin
        ? " admin"
        : n.UserLevel.IsContributor
        ? " contributor"
        : "",
      e =
  ...
  renderCountDownTimeDisplay: function (n, t) {
    ...
    var u = Math.floor(n / 60),
      e = n - u * 60,
      o = [
        "<div class='count-down-part count-down-days' data-label='" +
          translate.instant("CONTEST_LABEL_DAYS") +
          "'>" +
          i +
          "</div>",
        "<div class='count-down-part count-down-hours' data-label='" +
          translate.instant("CONTEST_LABEL_HOURS") +
          "'>" +
          r +
          "</div>",
        "<div class='count-down-part count-down-minutes' data-label='" +
          translate.instant("CONTEST_LABEL_MINUTES") +
          "'>" +
          u +
          "</div>",
        "<div class='count-down-part count-down-seconds' data-label='" +
          translate.instant("CONTEST_LABEL_SECONDS") +
          "'>" +
          e +
          "</div>",
...
$(window).load(function () {
  ...
  if ($(".site-header")[0]) {
    ...
    $(window).on("scroll", function () {
      ...
      u < t
        ? n.not(".is-sticky").addClass("is-sticky")
        : n.removeClass("is-sticky");
    });
  }
  i = 0;
...
$(function () {
  ...
  $(document).on("click", ".header-user-profile a", function (n) {
    $(this).attr("href") != "#"
      ? $(this).closest(".header-user-profile").removeClass("open")
      : n.preventDefault();
  });
        ...
        $(".list-courses>.row").each(function () {
          ...
          if (w_width > 1200 && $(this).find(".course-item").length > 8) {
            $(this).slick({
              ...
              arrows: true,
              prevArrow:
                "<span class='slick-prev btn-carousel'><i class='cl-icon-angle-left'></i></span>",
              nextArrow:
                "<span class='slick-next btn-carousel'><i class='cl-icon-angle-right'></i></span>",
            });
          }
          //Case have more more than 5 and in small laptop
            ...
            w_width > 1024 &&
            w_width < 1201 &&
            $(this).find(".course-item").length > 6
          ) {
            $(this).slick({
              slidesToShow: 3,
              slidesToScroll: 3,
          ...
          //Case have more more than 3 and in tablet
            ...
            w_width > 556 &&
            w_width < 1025 &&
            $(this).find(".course-item").length > 4
          ) {
            $(this).slick({
              slidesToShow: 2,
              slidesToScroll: 2,
